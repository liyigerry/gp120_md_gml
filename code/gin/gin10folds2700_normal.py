...
dataset_name_ = "/home/dldx/UniRep/dataset/dataset_2700_normal.p"
with open(dataset_name_, 'rb') as f:
...
for fold_idx in range(10):
    ...
    for epoch, _, _ in zip(tbar, vbar, lrbar):
        ...
        if valid_acc > valid_acc_tmp:
            valid_acc_tmp=valid_acc
                #    #保存模型
            PATH='/home/dldx/UniRep/Model_Trained/gin_normal_best'+str(fold_idx)
    ...
    lrbar.close()
    #    #保存模型
#     PATH='/home/dldx/UniRep/Model_Trained/gin_normal_'+str(fold_idx)
#     torch.save(model.state_dict(),PATH)
    print("第{}折完成,准确率{}".format(fold_idx,valid_acc_tmp)) 

loss_acc='gin_acc_10fold_2700_normal.p'
